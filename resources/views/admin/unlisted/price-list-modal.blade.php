                ...
                <tbody>
                    ...
                    <tr @class(['pl-row-alt'=> $loop->even]) data-date="{{ $row->UL_PD_DATE }}">
                        ...
                        <td>
                            ...
                            @else
                            <span style="color:#076550;font-weight:500">Valid</span>
                            @endif
                        </td>
                        <td>
...
(function () {
    ...
    $tbody.on('click', '.pl-edit-btn', function () {
        ...
        $row.find('.pl-bid').html('<input type="number" step="0.01" min="0" value="' + bid + '" id="plEditBid" style="width:80px;padding:4px 6px;border:1.5px solid #076550;border-radius:6px;font-size:13px">');
        $row.find('td:last').html(
            '<i class="fa-solid fa-check pl-save-btn" data-date="' + date + '" style="color:#076550;cursor:pointer;margin-right:10px;font-size:13px" title="Save"></i>' +
