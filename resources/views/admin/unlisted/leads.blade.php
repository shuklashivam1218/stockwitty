...
@section('title', 'Leads | Admin | StockWitty')
...
<style>
    ...
    .leads-filters input:focus, .leads-filters select:focus { outline: none; border-color: #076550; }
    ...
    .lead-alloc-select:focus { outline: none; border-color: #076550; }
    .disp-badge {
    ...
    .disp-edit-btn:hover { color: #076550; background: #e8f5f1; }
    ...
    .leads-pagination .pg-btn:hover { background: #e8f5f1; border-color: #076550; color: #076550; }
    .leads-pagination .pg-btn:disabled { opacity: 0.4; cursor: not-allowed; }
    .leads-pagination .pg-btn.active { background: #076550; border-color: #076550; color: #fff; }
    ...
    #dispModal .dm-field textarea:focus { outline: none; border-color: #076550; }
    ...
    #dmSubmitBtn { background: #076550; color: #fff; }
    #dmSubmitBtn:hover { background: #054d3c; }
        ...
        <div class="leads-filters">
            ...
            <div class="filter-group" style="justify-content:flex-end;">
                ...
                <div style="display:flex;gap:6px;">
                    <button class="filter-btn" onclick="loadLeads(1)" style="background:#076550;color:#fff;">
...
$(document).on('change', '.lead-alloc-select', function () {
    ...
    .done(function (res) {
        if (res.success) {
            ...
            if (agentUid) {
                $lbl.html('<i class="fa-solid fa-circle-check" style="font-size:10px;"></i> ' + agentName).css('color', '#076550');
            } else {
