...
<style>
    ...
    .ord-filters input:focus, .ord-filters select:focus { outline: none; border-color: #076550; }
    ...
    .eom-field input:focus, .eom-field select:focus { outline: none; border-color: #076550; }
        ...
        <div class="ord-filters">
            ...
            <div class="filter-group" style="justify-content:flex-end;">
                ...
                <div style="display:flex;gap:6px;">
                    <button class="filter-btn" onclick="loadOrders(1)" style="background:#076550;color:#fff;">
...
$(document).on('click', '.copy-order-btn', function () {
    ...
    navigator.clipboard.writeText(text).then(function () {
        $btn.html('<i class="fa-solid fa-check" style="color:#076550;"></i>');
