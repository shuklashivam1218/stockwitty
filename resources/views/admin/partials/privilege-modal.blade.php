    ...
    <form id="privForm">
        ...
        <div class="priv-body">
            ...
            <div class="priv-section">
                ...
                <label class="priv-toggle-row">
                    <div class="priv-toggle-info">
                        <span class="priv-toggle-name">Author</span>
                        <span class="priv-toggle-desc">Write & submit content</span>
                    </div>
                    <label class="priv-switch">
                        <input type="checkbox" name="author" {{ $checked(!empty($p['author'])) }}>
                        <span class="priv-slider"></span>
                    </label>
                </label>
                ...
                <label class="priv-toggle-row">
                    <div class="priv-toggle-info">
                        <span class="priv-toggle-name">Reviewer</span>
                        <span class="priv-toggle-desc">Review & approve submitted content</span>
                    </div>
                    <label class="priv-switch">
                        <input type="checkbox" name="reviewer" {{ $checked(!empty($p['reviewer'])) }}>
                        <span class="priv-slider"></span>
                    </label>
                </label>
            </div>
