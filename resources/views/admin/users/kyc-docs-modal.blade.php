...
$(document).on('click', '.kyc-verify-btn', function () {
    ...
    .done(function (res) {
        if (res.success) {
            ...
            if (res.all_verified) {
                $tableBtn.html('<i class="fa-solid fa-circle-check" style="color:#076550;margin-right:4px"></i> Verified');
            } else {
